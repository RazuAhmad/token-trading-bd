...
function BuyForm() {
  ...
  <option value="saab">Nagad</option>
            ...
            {/* <input className='' type="text"  placeholder='Your Payment Details'/> */}
            <textarea className='w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500' name="fieldname"></textarea>
            </p>
